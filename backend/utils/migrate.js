...
const runMigrations = async () => {
  ...
  try {
    ...
    await addMissingColumns(client, 'sessions', [
      ...
      { name: 'member_id', type: 'INTEGER REFERENCES users(id) ON DELETE CASCADE' }
    ]);
      ...
      case 'chat_messages':
        await client.query(`
          CREATE TABLE chat_messages (
            ...
            sender_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
      ...
      case 'payouts':
        await client.query(`
          CREATE TABLE payouts (
            id SERIAL PRIMARY KEY,
            creator_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
      ...
      case 'followers':
        await client.query(`
          CREATE TABLE followers (
            id SERIAL PRIMARY KEY,
            creator_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
            follower_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
            created_at TIMESTAMP DEFAULT NOW(),
      ...
      case 'messages':
        await client.query(`
          CREATE TABLE messages (
            id SERIAL PRIMARY KEY,
            sender_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
            recipient_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
            subject VARCHAR(255),
      ...
      case 'creator_applications':
        await client.query(`
          CREATE TABLE creator_applications (
            ...
            reviewed_by VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE SET NULL,
            review_notes TEXT,
      ...
      case 'session_ratings':
        await client.query(`
          CREATE TABLE session_ratings (
            ...
            rater_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
      ...
      case 'creator_subscriptions':
        await client.query(`
          CREATE TABLE creator_subscriptions (
            id SERIAL PRIMARY KEY,
            subscriber_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
            creator_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
      ...
      case 'blocked_content':
        await client.query(`
          CREATE TABLE blocked_content (
            ...
            unblocked_by VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE SET NULL
          )
        `);
      ...
      case 'user_penalties':
        await client.query(`
          CREATE TABLE user_penalties (
            ...
            reason TEXT,
            applied_by VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE SET NULL,
            created_at TIMESTAMP DEFAULT NOW(),
            expires_at TIMESTAMP,
            is_active BOOLEAN DEFAULT TRUE,
      ...
      case 'recording_views':
        await client.query(`
          CREATE TABLE recording_views (
            ...
            viewer_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
      ...
      case 'recording_clips':
        await client.query(`
          CREATE TABLE recording_clips (
            ...
            recording_id INTEGER REFERENCES stream_recordings(id) ON DELETE CASCADE,
            creator_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
            created_by VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
            title VARCHAR(255) NOT NULL,
            description TEXT,
      ...
      case 'offer_purchases':
        await client.query(`
          CREATE TABLE offer_purchases (
            ...
            buyer_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
            creator_id VARCHAR(255) REFERENCES users(firebase_uid) ON DELETE CASCADE,
...
const createIndexes = async (client) => {
  const indexes = [
    { table: 'users', name: 'idx_users_firebase_uid', column: 'firebase_uid' },
    ...
    { table: 'sessions', name: 'idx_sessions_member_id', column: 'member_id' },
...
const addConstraints = async (client) => {
  const constraints = [
    ...
    { table: 'sessions', name: 'check_different_users', constraint: 'CHECK (creator_id != member_id)' },
