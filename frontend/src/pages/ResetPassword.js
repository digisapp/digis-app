...
import { updatePassword, supabase } from '../utils/supabase-auth';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 via-pink-900 to-red-900">
        <motion.div
          ...
          className="max-w-md w-full bg-black/50 backdrop-blur-xl p-8 rounded-2xl border border-white/10 text-center"
        >
          ...
          <p className="text-gray-300">Your password has been updated. Redirecting to login...</p>
        </motion.div>
      </div>
    );
  }
