...
const CreatorAvailabilitySystem = ({ 
  user, 
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      ...
      <div className={`flex items-center gap-3 p-4 rounded-lg bg-${currentStatusConfig.color}-50 border-2 border-${currentStatusConfig.color}-200 mb-6`}>
...
export const StatusIndicator = ({ status, size = 'sm', showLabel = false }) => {
