  ...
  const fetchCollaborations = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setCollaborations(data.collaborations || mockCollaborations);
      }
    } catch (error) {
              ...
              >
                ...
                <div className="p-6 border-b border-gray-200">
                  <div className="flex items-center justify-between">
                    <h2 className="text-2xl font-bold text-gray-900">Post New Collaboration</h2>
                    <button
                      onClick={() => setShowNewCollabModal(false)}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-purple-600 to-pink-600 text-transparent bg-clip-text">Active Collaborations</h2>
          <p className="text-gray-600 text-lg">Find your next creative partnership</p>
        </div>
        <motion.button
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{collab.creator.followers.toLocaleString()} followers</p>
                      </div>
                    </div>
...
const ExperiencesSection = ({ trips, showNewTripModal, setShowNewTripModal, isAdmin, user }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-purple-600 to-pink-600 text-transparent bg-clip-text">Creator Experiences</h2>
          <p className="text-gray-600 text-lg">Exclusive experiences created by Digis for creators</p>
        </div>
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">{trip.organizer}</p>
                      <p className="text-xs text-gray-500">{trip.duration}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-xs text-gray-500">{trip.dates.split('-')[0]}</p>
                    <p className="text-xs font-medium text-gray-700">{trip.participants} going</p>
                  </div>
                </div>
        ...
        {showBookingModal && selectedExperience && (
          ...
          >
            ...
            >
              ...
              <div className="p-6 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <h2 className="text-2xl font-bold text-gray-900">Book Experience</h2>
                  <button
                    onClick={() => setShowBookingModal(false)}
                    className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
                  >
              ...
              <div className="p-6">
                {/* Experience Summary */}
                <div className="mb-6">
                  <h3 className="text-xl font-bold mb-2">{selectedExperience.destination}</h3>
                ...
                <div className="p-4 bg-purple-50 rounded-xl mb-6">
                  <div className="flex items-center justify-between">
                    ...
                    <p className="text-2xl font-bold text-purple-600">{selectedExperience.tokenCost.toLocaleString()} Tokens</p>
                  </div>
                  <p className="text-sm text-gray-600 mt-1">Payment will be processed immediately upon confirmation</p>
                </div>
        ...
        {showCreatorExperienceModal && (
          ...
          >
            ...
            >
              ...
              <div className="p-6 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <h2 className="text-2xl font-bold text-gray-900">Create Your Experience</h2>
                  <button
                    onClick={() => setShowCreatorExperienceModal(false)}
                    className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
                  >
                ...
                <p className="text-gray-600 mt-2">Submit your experience for admin approval</p>
              </div>
