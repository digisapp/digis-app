...
const CreatorSubscriptionManagement = ({ user }) => {
  ...
  const loadSubscriptionData = async () => {
    ...
    try {
      ...
      const plansResponse = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/api/subscriptions/creator/${user.uid}/plans`,
        {
          headers: {
  ...
  const handleCreatePlan = async () => {
    ...
    if (parseFloat(planForm.price) <= 0) {
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === 'tiers' && (
        <div className="space-y-6">
          {/* Removed Create New Plan Button */}
              ...
              <button
                onClick={() => {
                  if (subscriptionPlans.length >= 3) {
                    setError('You can only create up to 3 subscription tiers');
                    return;
                  }
                  resetForm();
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 flex items-start gap-3">
            ...
            <div className="text-sm text-blue-800 dark:text-blue-200">
              ...
              <ul className="list-disc list-inside space-y-1 text-blue-700 dark:text-blue-300">
                <li>Offer multiple tiers to cater to different budget levels</li>
                <li>Clearly define the benefits and perks for each tier</li>
                    ...
                    {subscribers.map((subscriber) => (
                      <tr key={subscriber.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/30 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <div className="text-sm text-gray-500 dark:text-gray-400">
                            ${subscriber.price}/{subscriber.billingInterval}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
            ...
            >
              <div className="p-6">
                <h2 className="text-2xl font-bold mb-6">
                  {showEditModal ? 'Edit Subscription Plan' : 'Create New Subscription Plan'}
                </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., Bronze Tier, Silver Tier, Gold Tier"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-8 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 disabled:bg-gray-100 dark:disabled:bg-gray-800 disabled:cursor-not-allowed"
                        />
                      </div>
                      {showEditModal && (
                ...
                <div className="flex gap-3 mt-8">
                  ...
                  <button
                    ...
                    disabled={loading || !planForm.name || !planForm.description || (!showEditModal && !planForm.price)}
