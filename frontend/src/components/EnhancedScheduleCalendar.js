                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">
                        {new Date(event.date).toLocaleDateString()} at {formatTime(new Date(event.date))}
                        {event.price > 0 && <span className="ml-2 font-medium text-purple-600">{event.price} tokens</span>}
                      </p>
                    </div>
                    ...
                    <div className="text-right">
                      <span className={`
                        ...
                        ${event.status === 'cancelled' ? 'bg-red-100 text-red-700 line-through' : ''}
                      `}>
                        {event.status}
                      </span>
                    </div>
