      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="relative bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl shadow-[0_20px_70px_-15px_rgba(34,197,94,0.3)] border border-white/20 dark:border-gray-700/30 overflow-hidden">
              ...
              <div className="p-6 relative" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
                ...
                <div className="flex items-center gap-2 mb-4">
                  <div className="relative">
                    <img
                      src={creator.avatar || creator.profile_pic_url || `https://ui-avatars.com/api/?name=${creator.username}&background=22C55E&color=fff`}
                      alt={creator.username}
                      className="w-8 h-8 rounded-full object-cover ring-2 ring-green-500/30 cursor-pointer hover:ring-4 hover:ring-green-500/50 transition-all"
                      width={32}
                      height={32}
                      onClick={(e) => {
                        e.stopPropagation();
                ...
                {/* Call info card */}
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-4 mb-4 border border-green-200/50 dark:border-green-700/30">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between text-sm pt-2 border-t border-green-200/50 dark:border-green-700/30">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className={`flex-1 px-4 py-3 rounded-xl font-semibold transition-all duration-200 flex items-center justify-center gap-2 relative overflow-hidden group ${
                      hasEnoughTokens
                        ? 'bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-lg hover:shadow-xl hover:from-green-700 hover:to-emerald-700 transform hover:-translate-y-0.5'
