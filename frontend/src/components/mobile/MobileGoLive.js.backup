...
const MobileGoLive = ({ onGoLive, onCancel, user }) => {
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 bg-black relative overflow-hidden">
              <video
                ...
                style={{
                  transform: 'scaleX(-1)',
                  display: deviceError || !isVideoEnabled ? 'none' : 'block'
                }}
              />
              ...
              {deviceError ? (
                <div className="absolute inset-0 flex items-center justify-center bg-gray-900">
                  <div className="text-center p-6">
                    ...
                    <p className="text-white text-sm mb-4">{deviceError}</p>
                    <button
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-500"
                  maxLength={100}
                />
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-500 appearance-none"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-500 resize-none"
                  rows={3}
                  maxLength={200}
                />
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="0"
                      className="w-full px-3 py-2 bg-white border border-purple-200 rounded-lg"
                    />
                    {joinPrice > 0 && (
