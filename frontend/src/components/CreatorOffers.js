...
const CreatorOffers = ({ creatorId, creatorUsername, auth }) => {
  const { tokenBalance, setTokenBalance } = useContext(AppContext);
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      setTokenBalance(prevBalance => prevBalance - selectedOffer.priceTokens);
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center text-green-600 font-semibold">
                  ...
                  <span>{offer.priceTokens.toLocaleString()} tokens</span>
                </div>
                {offer.deliveryTime && (
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-green-600">
                      {selectedOffer.priceTokens.toLocaleString()} tokens
                    </span>
                  </div>
                ...
                <div className="bg-blue-50 rounded-lg p-3 mb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`font-semibold ${
                      tokenBalance >= selectedOffer.priceTokens ? 'text-green-600' : 'text-red-600'
                    }`}>
                  ...
                  {tokenBalance < selectedOffer.priceTokens && (
                    <p className="text-sm text-red-600 mt-2">
                      You need {(selectedOffer.priceTokens - tokenBalance).toLocaleString()} more tokens
                    </p>
                  )}
                </div>
              </div>
