...
const InstantMessagingChat = ({ 
  ...
  useEffect(() => {
    if (showOnlineFollowers && onlineFollowers.length === 0) {
      const mockFollowers = [
        {
          id: 'follower1',
        ...
        },
        {
          ...
          followingSince: '2024-01-05'
        }
      ];
      setOnlineFollowers(mockFollowers);
    }
  }, [showOnlineFollowers, onlineFollowers.length]);
