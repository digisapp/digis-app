...
const MassMessageModal = ({ isOpen, onClose, totalFans = 0 }) => {
              ...
              <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-6 text-white">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold">Message All Fans</h2>
                      <p className="text-purple-100">Send a message to {totalFans} followers</p>
                    </div>
                  </div>
                  <button
                    onClick={onClose}
