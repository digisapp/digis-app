...
const TVSubscriptionModal = ({ 
  ...
  const benefits = [
    ...
    'Access to stream archives and replays'
  ];
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-8">
                ...
                <h2 className="text-3xl font-bold text-gray-900 mb-2">Digis TV Subscription</h2>
                <p className="text-gray-600">Watch unlimited public live streams from creators worldwide</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                {isTrialAvailable && (
                  <motion.button
                    ...
                    className="w-full bg-gradient-to-r from-green-500 to-emerald-500 text-white py-4 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group"
                  >
