...
-- Step 3: Create a function to handle user updates (email, metadata, etc.)
...
-- ============================================
-- OPTIONAL: Clean up duplicate ID columns
-- ============================================
-- Your users table has two 'id' columns which is problematic.
-- If you want to fix this, run these commands CAREFULLY:
-- 
-- 1. First, backup your data!
-- 2. Then uncomment and run:
-- 
-- ALTER TABLE public.users DROP COLUMN IF EXISTS id CASCADE; -- Drop the integer id
-- ALTER TABLE public.users RENAME COLUMN id TO id; -- Keep the UUID id
-- ============================================